...
public class LatLongService {
    ...
    private static String LOG_TAG = "Mela On Go/LatLongService";
    private static String API_URL = "https://admin.plotprojects.com/api/v1/";
    private String accountId;

    public LatLongService(String accountId, String privateKey) {
    ...
    public String createPlace(double latitude,double longitude) throws JSONException, IOException {
