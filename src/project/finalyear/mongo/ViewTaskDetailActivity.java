...
import project.finalyear.controller.ApplicationNavigationHandler;
import project.finalyear.controller.ConfirmDeletionDialog;
...
public class ViewTaskDetailActivity extends GeneralActivity {
	...
	private void putDataToView(){
		...
		if(this.task == null){
			...
			// set the location
			TextView taskLocationTextView = (TextView) findViewById(R.id.activity_view_task_detail_TextView_Location_content);
			taskLocationTextView.setText(this.task.getLocation());
			...
			if(this.task.getCollaborators().isEmpty()){
				...
				collaboratorsTextView.setText("There are no MeetUps.");
			} else {
