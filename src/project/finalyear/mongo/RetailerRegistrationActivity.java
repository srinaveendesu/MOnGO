...
public class RetailerRegistrationActivity extends Activity {
SQLiteHelper sq;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button_registration.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				sq.insertRetailerLoginData(edittext_username.getText().toString(), edittext_password.getText().toString());
				Toast.makeText(RetailerRegistrationActivity.this, "Registered", 10).show();
				 Intent launchactivity = new Intent(RetailerRegistrationActivity.this,LoginActivity.class);
