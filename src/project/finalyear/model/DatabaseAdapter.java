...
public class DatabaseAdapter {
	...
	// Database name
	public static final String DATABASE_NAME = "Mongo_task_management.db";
	...
	// Task table - location column name
	public static final String TASK_TABLE_COLUMN_LOCATION = "_location";
	...
	public static final String TASK_TABLE_CREATE
			...
			+ TASK_TABLE_COLUMN_LOCATION + " text,"
	...
	public void insertTask(Task task){
		...
		initialValues.put(TASK_TABLE_COLUMN_LOCATION, task.getLocation());
	...
	public Cursor getAllTasks(){
		return sqLiteDatabase.query(TASK_TABLE_NAME,
				new String[] {TASK_TABLE_COLUMN_ID, TASK_TABLE_COLUMN_TITLE, TASK_TABLE_COLUMN_DUE_DATE, TASK_TABLE_COLUMN_LOCATION, TASK_TABLE_COLUMN_PRIORITY, TASK_TABLE_COLUMN_GROUP, TASK_TABLE_COLUMN_COMPLETION_STATUS},
	...
	public void editExistingTask(Task task){
		...
		updateValues.put(TASK_TABLE_COLUMN_LOCATION, task.getLocation());
